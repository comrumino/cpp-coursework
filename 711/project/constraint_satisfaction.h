...
public:
    ...
    ConstraintSatisfaction(std::string prdct, std::string lcns, std::string exp,
                           std::string usrs = "0", std::string rlsts = "0", std::string devs = "0",
...
public:
    ...
    NPLiveConstraint(std::string prdct, std::string lcns, std::string exp,
                     std::string usrs = "0", std::string rlsts = "0", std::string devs = "0",
                     const bool signature = false);
...
public:
    ...
    NPViewConstraint(std::string prdct, std::string lcns, std::string exp,
                     std::string usrs = "0", std::string rlsts = "0", std::string devs = "0",
                     const bool signature = false);
    const bool is_discretionary() override;  // check the license is within limits via datastore
private:
