...
Board::Board(const unsigned int numRows, const unsigned int numCols, const Dictionary &dict,
        const strvector &debug)
...
const unsigned int Board::NumRows() const {
    return mNumRows;
}

const unsigned int Board::NumCols() const {
    return mNumCols;
}
...
char Board::operator()(unsigned int row, unsigned int col) const {
    return mBoard[row][col];
}

const std::string &Board::operator()(unsigned int row) const {
    return mBoard[row];
}
